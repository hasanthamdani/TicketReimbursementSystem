...
public class TicketRepositoryTest
{
    ...
    public void testfindByUsername()
    {
        ...
        assert(retrievedTicket.isPresent());
        assert(retrievedTicket.get().getEmployee().getUsername()).equals("testuser");
        assert(retrievedTicket.get().getDescription()).equals("description");
        assert(retrievedTicket.get().getStatus()).equals("pending");
    }
